...
# Upgrading Spring Boot using OpenRewrite

## Introduction to OpenRewrite 

[OpenRewrite](https://docs.openrewrite.org/) is an automated refactoring ecosystem for source code, enabling developers to effectively eliminate technical debt within their repositories.
...
3) Run the Rewrite/rewriteDryRun to see what will be changed in the project, this is optional
4) Run the Rewrite/rewriteRun, this updates the project, you will get compile errors
5) Go to Project Structure... and change the SDK from Java 11 to Java 17 
6) Reload All Gradle Projects
7) Run the application/bootRun gradle task and start the project
...
## [Migrate to Spring Boot 3.2](https://docs.openrewrite.org/recipes/java/spring/boot3/upgradespringboot_3_2)
...
Congratulations, your project  was updated to version 3.2.4!
